...
public class PluginListener implements Listener
{
    ...
    public void onInteract5(PlayerInteractEvent e)
    {
        ...
        if (action.equals(Action.RIGHT_CLICK_AIR) || action.equals(Action.RIGHT_CLICK_BLOCK))
        {
            ...
            if (inHand.getType() == Material.WRITTEN_BOOK)
            {
                ...
                {
                    System.out.println(player.getName() + " opened book: " + inHand.serialize().toString());
                }
    ...
    //THIS SECTION CAUSES CRASHES, FIXING TODO
    /*@EventHandler(priority = EventPriority.HIGHEST)
    public void onEntitySpawned(CreatureSpawnEvent e)
    {
        ...
        {
            if(nmsEntity.getAttributeInstance(GenericAttributes.FOLLOW_RANGE).getValue() > 100)
            {
